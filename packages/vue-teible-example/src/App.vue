  ...
  <div id="app">
    <section class="hero">
      ...
      <h3 class="hero__subtitle">
        Example for <a class="hero__link" href="https://github.com/hiendv/teible/tree/master/packages/vue-teible" title="vue-teible">vue-teible</a>
      </h3>
    ...
    <main>
      <div class="demos">
        ...
        <demo :items="itemsArr" class="demo">
          ...
          <p class="demo__subtitle">
            Searching using `indexOf` with queries in lowercase.
          </p>
        </demo>
      </div>
    </main>
